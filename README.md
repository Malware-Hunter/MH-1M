...
Before running any scripts or tools, install your project’s Python requirements:

 ```bash
pip install -r requirements.txt
```
Ensure you’re using the correct Python environment (e.g., virtualenv, conda) when installing.
...
To unzip the data:
  ...
  ```bash
 7z x /data/compressed/mh-1m/mh1M-[intents-permissions-opcodes-apicalls].7z.001
```
  

## **Move to data/processed**

Move the .npz to the data/processed folder. if not exist, create one.
